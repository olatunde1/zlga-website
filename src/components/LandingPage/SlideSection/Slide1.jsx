    ...
    <Box bg={'#F3FFF1'} position={'relative'}>
       ...
       <Stack direction={{ base: 'column', md: 'row' }} position={'relative'}>
         ...
         <Stack direction="column" >
           ...
           >
            Our recycling services include collection of recyclable materials
             from commercial, industrial and residential customers for which we
              charge collection and processing fees.
           </Text>
           <HStack spacing={3}>
             <Button 
                position='absolute'
