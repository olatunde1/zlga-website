    ...
    <Box bg={'#F3FFF1'} position={'relative'}>
       ...
       <Stack direction={{ base: 'column', md: 'row' }} position={'relative'}>
         ...
         <Stack direction="column" >
           ...
           >
           As is a common knowledge in our company, 
           waste management strategies without effective 
           waste containerization is counter productive, 
           we recognize that effective containerization drives effective waste management.
           </Text>
           <HStack spacing={3}>
             <Button 
                position='absolute'
