    ...
    <Box bg={'#F3FFF1'} position={'relative'}>
       ...
       <Stack direction={{ base: 'column', md: 'row' }} position={'relative'}>
         ...
         <Stack direction="column" >
           ...
           >
           According to our intelligence, Vector-borne infections have been 
           recorded to be one of the largest causes of health risks that have 
           long impacted the human health for decades especially in Sub-Saharan Africa.
           </Text>
           <HStack spacing={3}>
             <Button
                position='absolute'
